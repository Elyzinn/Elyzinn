...
- 🎓 Cursando **Sistemas para Internet** na **Unialfa**.
- 💼 Tenho **2 anos de experiência** como Auxiliar Técnico de Informática na **Norospar**, atuando com
  - Suporte ao usuário e gestão de sistemas (SPData).
  - Manutenção de computadores e infraestrutura de redes
- 🗣️ **Inglês**
- 🏆 Participante de **Hackathons** (Projeto recente: *Portal de Estágios*)
- 🎯 Buscando oportunidades na área de TI para crescer profissionalmente e desenvolver novas soluções
